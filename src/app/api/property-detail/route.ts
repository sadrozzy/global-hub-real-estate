...
const generateMockProperty = (id: string): PropertyDetailData => {
	const properties = [
		...
		},
		{
			...
			type: 'Apartment',
			description:
				'Stunning modern loft in the heart of downtown with floor-to-ceiling windows, exposed brick walls, and premium finishes throughout. This urban oasis features an open-concept design perfect for modern living and entertaining.',
			location: {
		...
		},
		{
			...
			type: 'Villa',
			description:
				'Exceptional beachfront villa offering panoramic ocean views and direct beach access. This architectural masterpiece features premium materials, smart home technology, and resort-style amenities including infinity pool and private dock.',
			location: {
	...
	const propertyIndex =
		id === '688c6e5f-7098-8333-873b-0f0703f3bf82'
			? 0
