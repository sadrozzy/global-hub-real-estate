...
import { PropertyDetailData } from '@/lib/property/types'
...
export default function PropertyDetail({ property }: PropertyDetailProps) {
	...
	useEffect(() => {
		...
		mapboxgl.accessToken =
			'pk.eyJ1IjoieWFuZ2NoZW4iLCJhIjoiMmZkYTdhMjIzMTgyNjVkOGM5Njg5ZTgxODU5OGIwNjIifQ.04dQNMp8CSbFG0zziBz3lA'
					...
					<div className='property-detail__content'>
						...
						<div className='property-detail__info-row'>
							...
							<div className='property-detail__about'>
								<h2 className='property-detail__about-title'>
									{t('sections.aboutThisHome')}
								</h2>
							...
							<div className='property-detail__agent-map-section'>
								...
								<div className='property-detail__agent-card'>
									<h3 className='property-detail__agent-title'>
										{t('sections.listedByAgent')}
									</h3>
									<div className='property-detail__agent-info'>
										...
										<div className='property-detail__agent-details'>
											<h4 className='property-detail__agent-name'>
												{property.agent.name}
											</h4>
											<p className='property-detail__agent-title-text'>
								...
								<div className='property-detail__map'>
									<h3 className='property-detail__map-title'>
										{t('sections.location')}
									</h3>
									<div className='property-detail__map-container'>
										<div
											ref={mapContainer}
											className='property-detail__map-box'
										/>
										<div className='property-detail__map-info'>
											<p className='property-detail__map-address'>
