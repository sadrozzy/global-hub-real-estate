    ...
    <div className="register-form">
      ...
      <div className="register-form__user-type">
        <button
          ...
          className={`register-form__user-type-btn ${
            formData.userType === 'customer' ? 'register-form__user-type-btn--active' : ''
          }`}
        ...
        <button
          type="button"
          className={`register-form__user-type-btn ${
            formData.userType === 'agent' ? 'register-form__user-type-btn--active' : ''
          }`}
      ...
      <form onSubmit={handleSubmit} className="register-form__form">
        ...
        <div className="register-form__divider">
          <span className="register-form__divider-text">{t('or')}</span>
        </div>
        ...
        <p className="register-form__signin-link">
          ...
          <Link href={`/${locale}/login`} className="register-form__link">
            {t('signInNow')}
          </Link>
        </p>
      </form>
